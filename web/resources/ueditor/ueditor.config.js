...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL + "imageUpload.do"              //图片上传提交地址
        ...
        ,fileOwnerUuidUrl: URL + "fileOwnerUuid.json"     //
        ,fileDeleteUrl: URL + "deleteUploadFile.do"       //
        ...
        ,imageManagerDeleteUrl:URL+"imageManagerDelete.do"    //删除
