...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL + "imageUpload.do?isAdmin=true"              //图片上传提交地址
        ,imagePath: ""   //URL + ""                         //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                  //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                           //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        //,maxImageSideLength:900                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ,savePath: [ 'image']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //附件上传配置区
        ,fileUrl:URL+"fileUpload.do"               //附件上传提交地址
        ,fileOwnerUuidUrl: URL + "fileOwnerUuid.json?isAdmin=true"     //
        ,fileDeleteUrl: URL + "deleteUploadFile.do?isAdmin=true"       //
        ...
        //图片在线管理配置区
        ,imageManagerUrl:URL+"imageManager.do?isAdmin=true"       //图片在线管理的处理地址
        ,imageManagerPath: "" //URL + "jsp/"                                    //图片修正地址，同imagePath
        ,imageManagerDeleteUrl:URL+"imageManagerDelete.do?isAdmin=true"    //删除
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help', 'drafts','wxemotion']
        ]
...
//           ]
        ...
        ,wordCountIgnoreHtml:false
        ,maximumWords:20000       //允许的最大字符数
        //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数,留空支持多语言自动切换，否则按此配置显示
        ,wordCountMsg:'已输入 {#count} 个字符(包含格式字符)，还可以输入{#leave} 个字符'
        //超出字数限制提示  留空支持多语言自动切换，否则按此配置显示
        ,wordOverFlowMsg:'<span style="color:red;">字符个数已经超出最大允许值，可以尝试清除部分无用格式！</span>'
